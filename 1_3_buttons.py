...
button = ttk.Button(
    window, text="A simple button", command=button_func, textvariable=button_string
)
button.pack()
...
exercise_radio1 = ttk.Radiobutton(
    window, text="Radio A", value="A", command=radio_func, variable=radio_string
)
exercise_radio2 = ttk.Radiobutton(
    window, text="Radio B", value="B", command=radio_func, variable=radio_string
)
