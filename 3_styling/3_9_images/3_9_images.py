...
image_original = Image.open(
    "/home/howard/sandbox/python_gui/3_styling/3_9_images/raccoon.jpg"
)
image_ratio = image_original.size[0] / image_original.size[1]
print(image_ratio)
image_tk = ImageTk.PhotoImage(image_original)

python_dark = Image.open(
    "/home/howard/sandbox/python_gui/3_styling/3_9_images/python_dark.png"
).resize((30, 30))
...
img_ctk = ctk.CTkImage(
    ...
    dark_image=Image.open(
        "/home/howard/sandbox/python_gui/3_styling/3_9_images/python_light.png"
    ),
)
